        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-[3.2rem] font-bold leading-[1.25] mb-5 text-[#0F4C3A]"
            >
            ...
            <motion.p
              ...
              className="text-neutral-600 text-lg sm:text-xl mb-8 max-w-lg leading-relaxed"
            >
            ...
            <motion.div
              ...
              className="flex items-center gap-2 text-neutral-500 text-sm mb-8"
            >
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center gap-6 pt-6 border-t border-neutral-200"
            >
              {[
          ...
          >
            <div className="relative w-full h-[320px] sm:h-[420px] lg:h-[500px]">
              <Image
                src="/hero_right.png"
                alt="Ovizog Legal Protection Graphic"
                fill
                priority
